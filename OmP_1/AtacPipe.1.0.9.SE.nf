...
process SAMTOOLS_FILTER {
    ...
    script:
    """
    samtools view -@ ${task.cpus} -bh -q 30 -F 1796 ${bam} > ${sample_id}.filtered.bam
    """
}
...
process FRAGMENT_SIZE_DIST {
    ...
    script:
    """
    bamPEFragmentSize -b ${bam} -hist ${sample_id}_fragment_size_dist.png --maxFragmentLength 1000
    """
}
